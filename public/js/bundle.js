        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              // confirmar login
              (0, _alerts.showAlert)('success', 'Logged in!'); // The window object is supported by all browsers. It represents the browser's window.
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); // https://axios-http.com/docs/res_schema
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            (0, _alerts.showAlert)('success', 'Logged out successfully'); // Si estamos en '/me' redirecionamos a '/'
            ...
            return _context2.abrupt("return", window.setTimeout(location.assign('/'), 3000));
          ...
          case 11:
            ...
            (0, _alerts.showAlert)('error', 'Error logging out!'); // https://
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibHVpc3JheWFzYyIsImEiOiJjajRmeTRoZjIxYWtjMnF0ZmthNWd3ZWpmIn0.QkaHLen9gHVxqXbpjdzMmw';
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Popup({
      ...
      closeOnClick: false,
      closeButton: false
    }).setText("Day: ".concat(location.day, " | ").concat(location.description)).setLngLat(location.coordinates).addTo(map);
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
...
},{}],"updateAccData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateAccData = void 0;
...
var updateAccData = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            urlPath = type === 'password' ? 'updatePassword' : 'updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "'User ".concat(type.toUpperCase(), " updated successfully'"));
            }
  ...
  return function updateAccData(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateAccData = updateAccData;
...
var stripe = Stripe('pk_test_51JQZrgGPrqrzLhkZoslM4xWsdRfPFruqtHRpjUgoLytGhlb3R7LPi8R9Dsyuo7ExZRqkx62dEebgYwYS6zfPlrVp00qdxn1S1y');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(checkoutSession); // Pasamos el session id para redireccionar a la página de stripe
          ...
          case 9:
            ...
            (0, _alerts.showAlert)('error', 'Oh no! Something went wrong');
...
var _updateAccData = require("./updateAccData");
...
// DOM Elements
var loginForm = document.querySelector('.login-form'); // ormulario de login

var mapBox = document.getElementById('map');
var logoutBtn = document.querySelector('.nav__el--logout'); // boton de logout

var userDataForm = document.querySelector('.form-user-data'); // datos de usario en '/me'

var userSettingsForm = document.querySelector('.form-user-settings'); // configuración de usuario en '/me'
...
if (loginForm) {
  loginForm.addEventListener('submit', function (event) {
    ...
    var email = document.getElementById('email').value; // obtenemos email

    var password = document.getElementById('password').value; // obtenemos password

    (0, _login.login)(email, password); // invocamos la función login
  });
}
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (event) {
    event.preventDefault(); // The FormData interface provides a way to easily construct a set of key/value pairs representing form fields and their values, which can then be easily sent using AJAX method.
    ...
    console.log(form);
    (0, _updateAccData.updateAccData)(form, 'data');
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              document.querySelector('.btn--save--password').textContent = 'Updating'; // seleccionamos los campos

              currentPassword = document.getElementById('password-current').value; //prettier-ignore

              newPassword = document.getElementById('password').value; //prettier-ignore

              confirmNewPassword = document.getElementById('password-confirm').value; //prettier-ignore
              // enviamos la solicitud y esperamos la respuesta

              _context.next = 7;
              return (0, _updateAccData.updateAccData)({
            ...
            case 7:
              ...
              document.querySelector('.btn--save--password').textContent = 'Save Password'; // Ponemos los campos en blanco
